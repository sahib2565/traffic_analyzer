...
def realTime():
    ...
    while True:
        ...
        if time.time() - start_time >= 60:
            insert_database(classes_names[0], up_list[0])
            insert_database(classes_names[1], up_list[1])
            insert_database(classes_names[2], up_list[2])
            insert_database(classes_names[3], up_list[3])
